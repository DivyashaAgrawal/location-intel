...
| Starbucks     | playwright    | pending live verify  | pending                       | 2026-04-20    | Registry carries best-guess selectors; re-check with `src/maintenance/discover_apis.py`. |
...
python src/maintenance/discover_apis.py                     # find hidden JSON APIs
